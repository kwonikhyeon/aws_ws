...
def generate_launch_description():
  ...
  default_model_path = os.path.join(pkg_share, 'models/turtlebot3_waffle.urdf')
  robot_localization_file_path = os.path.join(pkg_share, 'config/ekf.yaml') 
  robot_name_in_urdf = 'tutlebot3_waffle'
  default_rviz_config_path = os.path.join(pkg_share, 'rviz/nav2_config.rviz')
  world_file_name = 'no_roof_small_warehouse/turtle_no_roof_small_warehouse.world'
